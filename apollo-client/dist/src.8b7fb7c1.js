...
exports.process = exports.invariant = exports.InvariantError = undefined;
...
exports.warnOnceInDevelopment = exports.variablesInOperation = exports.valueToObjectRepresentation = exports.valueFromNode = exports.tryFunctionOrLogError = exports.toIdValue = exports.stripSymbols = exports.storeKeyNameFromField = exports.shouldInclude = exports.resultKeyNameFromField = exports.removeFragmentSpreadFromDocument = exports.removeDirectivesFromDocument = exports.removeConnectionDirectiveFromDocument = exports.removeClientSetsFromDocument = exports.removeArgumentsFromDocument = exports.mergeDeepArray = exports.mergeDeep = exports.maybeDeepFreeze = exports.isTest = exports.isScalarValue = exports.isProduction = exports.isNumberValue = exports.isJsonValue = exports.isInlineFragment = exports.isIdValue = exports.isField = exports.isEnv = exports.isDevelopment = exports.hasDirectives = exports.hasClientExports = exports.graphQLResultHasError = exports.getStoreKeyName = exports.getQueryDefinition = exports.getOperationName = exports.getOperationDefinitionOrDie = exports.getOperationDefinition = exports.getMutationDefinition = exports.getMainDefinition = exports.getInclusionDirectives = exports.getFragmentQueryDocument = exports.getFragmentDefinitions = exports.getFragmentDefinition = exports.getEnv = exports.getDirectivesFromDocument = exports.getDirectiveNames = exports.getDirectiveInfoFromField = exports.getDefaultValues = exports.createFragmentMap = exports.cloneDeep = exports.checkDocument = exports.canUseWeakMap = exports.buildQueryFromSelectionSet = exports.assign = exports.argumentsObjectFromField = exports.addTypenameToDocument = exports.isEqual = undefined;
...
function toIdValue(idConfig, generated) {
    ...
    return (0, _tslib.__assign)({ type: 'id', generated: generated }, typeof idConfig === 'string' ? { id: idConfig, typename: undefined } : idConfig);
}
...
function getFragmentQueryDocument(document, fragmentName) {
    ...
    var query = (0, _tslib.__assign)((0, _tslib.__assign)({}, document), { definitions: (0, _tslib.__spreadArrays)([{
    ...
    return (0, _visitor.visit)(checkDocument(doc), {
        SelectionSet: {
            enter: function (node, _key, parent) {
                ...
                return (0, _tslib.__assign)((0, _tslib.__assign)({}, node), { selections: (0, _tslib.__spreadArrays)(selections, [TYPENAME_FIELD]) });
            }
        }
    });
}
            ...
            enter: function (node, _key, _parent, path) {
                ...
                if (!parentPath || currentPath === parentPath || !currentPath.startsWith(parentPath)) {
                    if (node.selections) {
                        ...
                        return (0, _tslib.__assign)((0, _tslib.__assign)({}, node), { selections: selectionsWithDirectives });
                    } else {
                        return null;
                    }
                }
...
function removeArgumentsFromDocument(config, doc) {
    ...
    return nullIfDocIsEmpty((0, _visitor.visit)(doc, {
        OperationDefinition: {
            enter: function (node) {
                return (0, _tslib.__assign)((0, _tslib.__assign)({}, node), { variableDefinitions: node.variableDefinitions.filter(function (varDef) {
...
function buildQueryFromSelectionSet(document) {
    ...
    var modifiedDoc = (0, _visitor.visit)(document, {
        OperationDefinition: {
            enter: function (node) {
                return (0, _tslib.__assign)((0, _tslib.__assign)({}, node), { operation: 'query' });
            }
        }
    });
    return modifiedDoc;
...
function shallowCopyForMerge(value, pastCopies) {
    if (value !== null && typeof value === 'object' && pastCopies.indexOf(value) < 0) {
        if (Array.isArray(value)) {
            ...
            value = (0, _tslib.__assign)({ __proto__: Object.getPrototypeOf(value) }, value);
        }
...
var Observable = _zenObservable2.default;
...
exports.toPromise = exports.split = exports.makePromise = exports.fromPromise = exports.fromError = exports.from = exports.execute = exports.empty = exports.createOperation = exports.concat = exports.ApolloLink = exports.getOperationName = exports.Observable = undefined;
...
Object.defineProperty(exports, 'Observable', {
    enumerable: true,
    get: function () {
        return _interopRequireDefault(_zenObservableTs).default;
    }
});
...
function execute(link, operation) {
    return link.request(createOperation(operation.context, transformOperation(validateOperation(operation)))) || _zenObservableTs2.default.of();
}
...
exports.isApolloError = exports.ObservableQuery = exports.NetworkStatus = exports.FetchType = exports.ApolloError = exports.ApolloClient = undefined;
...
var ObservableQuery = function (_super) {
    ...
    ObservableQuery.prototype.getCurrentResult = function () {
        ...
        if (!partial) {
            this.updateLastResult((0, _tslib.__assign)((0, _tslib.__assign)({}, result), { stale: false }));
        }
        return (0, _tslib.__assign)((0, _tslib.__assign)({}, result), { partial: partial });
    };
    ...
    ObservableQuery.prototype.refetch = function (variables) {
        ...
        return this.queryManager.fetchQuery(this.queryId, (0, _tslib.__assign)((0, _tslib.__assign)({}, this.options), { fetchPolicy: fetchPolicy }), FetchType.refetch);
    };
    ObservableQuery.prototype.fetchMore = function (fetchMoreOptions) {
        ...
        var combinedOptions = (0, _tslib.__assign)((0, _tslib.__assign)({}, fetchMoreOptions.query ? fetchMoreOptions : (0, _tslib.__assign)((0, _tslib.__assign)((0, _tslib.__assign)({}, this.options), fetchMoreOptions), { variables: (0, _tslib.__assign)((0, _tslib.__assign)({}, this.variables), fetchMoreOptions.variables) })), { fetchPolicy: 'network-only' });
    ...
    ObservableQuery.prototype.setUpQuery = function () {
        ...
        var onError = function (error) {
            _this.updateLastResult((0, _tslib.__assign)((0, _tslib.__assign)({}, _this.lastResult), { errors: error.graphQLErrors, networkStatus: NetworkStatus.error, loading: false }));
...
var LocalState = function () {
            ...
            return (0, _tslib.__generator)(this, function (_c) {
                if (document) {
                    return [2, this.resolveDocument(document, remoteResult.data, context, variables, this.fragmentMatcher, onlyRunForcedResolvers).then(function (localResult) {
                        return (0, _tslib.__assign)((0, _tslib.__assign)({}, remoteResult), { data: localResult.result });
                    })];
                }
    ...
    LocalState.prototype.prepareContext = function (context) {
        ...
        var newContext = (0, _tslib.__assign)((0, _tslib.__assign)({}, context), { cache: cache, getCacheKey: function (obj) {
                if (cache.config) {
        ...
        return (0, _tslib.__awaiter)(this, void 0, void 0, function () {
            ...
            return (0, _tslib.__generator)(this, function (_b) {
                ...
                execContext = {
                    ...
                    context: (0, _tslib.__assign)((0, _tslib.__assign)({}, context), { cache: cache,
                        client: client }),
                    variables: variables,
            ...
            return (0, _tslib.__generator)(this, function (_a) {
                ...
                if (!execContext.onlyRunForcedResolvers || this.shouldForceResolvers(field)) {
                    ...
                    if (resolverMap) {
                        ...
                        if (resolve) {
                            resultPromise = Promise.resolve(resolve(rootValue, (0, _apolloUtilities.argumentsObjectFromField)(field, variables), execContext.context, { field: field, fragmentMap: execContext.fragmentMap }));
                        }
                    }
                }
...
var QueryManager = function () {
                ...
                switch (_f.label) {
                    ...
                    case 2:
                        ...
                        return [2, new Promise(function (resolve, reject) {
                            var storeResult;
                            var error;
                            self.getObservableFromLink(mutation, (0, _tslib.__assign)((0, _tslib.__assign)({}, context), { optimisticResponse: optimisticResponse }), variables, false).subscribe({
                                next: function (result) {
            ...
            return (0, _tslib.__generator)(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        _e.label = 2;
                    case 2:
                        options = (0, _tslib.__assign)((0, _tslib.__assign)({}, options), { variables: variables });
    ...
    QueryManager.prototype.getObservableFromLink = function (query, context, variables, deduplication) {
        ...
        if (serverQuery) {
            ...
            var operation = {
                ...
                context: this.prepareContext((0, _tslib.__assign)((0, _tslib.__assign)({}, context), { forceFetch: !deduplication }))
            };
    ...
    QueryManager.prototype.prepareContext = function (context) {
        ...
        return (0, _tslib.__assign)((0, _tslib.__assign)({}, newContext), { clientAwareness: this.clientAwareness });
    };
    ...
    QueryManager.prototype.startPollingQuery = function (options, queryId, listener) {
        ...
        if (!this.ssrMode) {
            ...
            info.options = (0, _tslib.__assign)((0, _tslib.__assign)({}, options), { fetchPolicy: 'network-only' });
...
var ApolloClient = function () {
    ...
    ApolloClient.prototype.watchQuery = function (options) {
        ...
        if (this.disableNetworkFetches && (options.fetchPolicy === 'network-only' || options.fetchPolicy === 'cache-and-network')) {
            options = (0, _tslib.__assign)((0, _tslib.__assign)({}, options), { fetchPolicy: 'cache-first' });
        }
...
exports.Cache = exports.ApolloCache = undefined;
...
exports.wrap = exports.defaultMakeCacheKey = exports.KeyTrie = exports.setTimeout = exports.noContext = exports.bindContext = exports.asyncFromGen = undefined;
...
exports.enhanceErrorWithDocument = exports.defaultNormalizedCacheFactory = exports.defaultDataIdFromObject = exports.assertIdValue = exports.WriteError = exports.StoreWriter = exports.StoreReader = exports.ObjectCache = exports.IntrospectionFragmentMatcher = exports.InMemoryCache = exports.HeuristicFragmentMatcher = undefined;
...
var StoreReader = function () {
    ...
    StoreReader.prototype.readQueryFromStore = function (options) {
        return this.diffQueryAgainstStore((0, _tslib.__assign)((0, _tslib.__assign)({}, options), { returnPartialData: false })).result;
    };
            ...
            if ((0, _apolloUtilities.isField)(selection)) {
                ...
                if (match) {
                    ...
                    if (match === 'heuristic' && fragmentExecResult.missing) {
                        fragmentExecResult = (0, _tslib.__assign)((0, _tslib.__assign)({}, fragmentExecResult), { missing: fragmentExecResult.missing.map(function (info) {
                                return (0, _tslib.__assign)((0, _tslib.__assign)({}, info), { tolerable: true });
                            }) });
                    }
        ...
        selectionSet.selections.forEach(function (selection) {
            ...
            if ((0, _apolloUtilities.isField)(selection)) {
                ...
                if (context.fragmentMatcherFunction && fragment.typeCondition) {
                    var id = dataId || 'self';
                    var idValue = (0, _apolloUtilities.toIdValue)({ id: id, typename: undefined });
                    var fakeContext = {
...
exports.throwServerError = exports.serializeFetchParameter = exports.selectURI = exports.selectHttpOptionsAndBody = exports.parseAndCheckHttpResponse = exports.fallbackHttpConfig = exports.createSignalIfSupported = exports.checkFetcher = undefined;
...
var selectHttpOptionsAndBody = function (operation, fallbackConfig) {
    ...
    var options = (0, _tslib.__assign)({}, fallbackConfig.options, { headers: fallbackConfig.headers, credentials: fallbackConfig.credentials });
    var http = fallbackConfig.http;
    configs.forEach(function (config) {
        options = (0, _tslib.__assign)({}, options, config.options, { headers: (0, _tslib.__assign)({}, options.headers, config.headers) });
...
exports.createHttpLink = exports.HttpLink = undefined;
...
exports.onError = exports.ErrorLink = undefined;
...
exports.gql = exports.HttpLink = undefined;
...
Object.defineProperty(exports, 'gql', {
    enumerable: true,
    get: function () {
        return _interopRequireDefault(_graphqlTag).default;
    }
});
...
var DefaultClient = function (_super) {
    ...
    function DefaultClient(config) {
        ...
        if (!cache) {
            cache = cacheRedirects ? new _apolloCacheInmemory.InMemoryCache({ cacheRedirects: cacheRedirects }) : new _apolloCacheInmemory.InMemoryCache();
        }
...
//# sourceMappingURL=/src.8b7fb7c1.map